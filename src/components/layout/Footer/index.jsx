      ...
      <div className="mt-28 sm:mt-36 md:mt-40 lg:mt-44 rounded-t-3xl py-10 px-3 bg-white">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 container max-w-[1424px] mx-auto">
          <div className="lg:col-span-2">
            <div className="rounded-3xl w-full px-8 py-10 text-white space-y-5 bg-black font-bold">
              <Link
                href={'/'}
              ...
              <h1 className="text-2xl md:text-3xl">
                Get our app for free today!
              </h1>
              <p className="text-lg md:text-xl">
                Duis aute irure dolor in reprehenderit suscin voluptate velit
                esse cillum dolore litum asus mauris odio retum euut enim.
              </p>
